...
1. **MainActivity** - Welcome/Landing screen
2. **CalculatorActivity** - EMI calculation and data input
3. **ResultActivity** - Budget balance display
...
- [TD Mortgage Calculator](https://ix0.apps.td.com/en/mortgage-payment-calculator) - Reference for EMI calculation
